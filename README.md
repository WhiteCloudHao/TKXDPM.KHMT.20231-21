...
Do các branch feature code(đối với các usecase khác, các nhánh rất khác nhau và khác code base nên bọn em chỉ tạo pull request(riêng feature phê duyệt đơn hàng đã merge vào nhánh main) mà không merge vào nhánh chính để không ảnh hưởng đến bài tập khác, chúng em rất xin lỗi vì sự bất tiện này đối với cô và anh Ta.)
