...
public class AdminScreenHandler extends BaseScreenHandler{
    ...
    @FXML private ImageView order;
    @FXML private ImageView signout;
...
//                adminConfirmOrderScreenHandler.show();
    ...
    public void setImage(){
        ...
        File file1 = new File(Configs.IMAGE_PATH + "/" + "order.png");
        Image img1 = new Image(file1.toURI().toString());
        order.setImage(img1);

        File file2 = new File(Configs.IMAGE_PATH + "/" + "signout.png");
        Image img2 = new Image(file2.toURI().toString());
        signout.setImage(img2);
    }
