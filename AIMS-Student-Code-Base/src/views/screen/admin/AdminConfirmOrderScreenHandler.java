...
//        this.orderMediaDetails = orderMediaDetails;
    ...
    public void initializeTableView() throws SQLException {
        ...
        col_customer.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getDeliveryInfo2().getEmail()));
        col_province.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getDeliveryInfo2().getProvince()));
        col_instructions.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getDeliveryInfo2().getShippingInstruction()));
        col_status.setCellValueFactory(new PropertyValueFactory<>("status"));
        col_phone.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getDeliveryInfo2().getPhoneNumber()));
