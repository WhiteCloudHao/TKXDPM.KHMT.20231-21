package com.example.aims_project2.utils;
...
public class Configs {
	...
	public static final String INVOICE_SCREEN_PATH = "/com/example/aims_project2/fxml/invoice.fxml";
	public static final String INVOICE_MEDIA_SCREEN_PATH = "/com/example/aims_project2/fxml/media_invoice.fxml";
	public static final String PAYMENT_SCREEN_PATH = "/com/example/aims_project2/fxml/payment.fxml";
	public static final String RESULT_SCREEN_PATH = "/com/example/aims_project2/fxml/result.fxml";
	public static final String SPLASH_SCREEN_PATH = "/com/example/aims_project2/fxml/splash.fxml";
	public static final String CART_SCREEN_PATH = "/com/example/aims_project2/fxml/cart.fxml";
	public static final String SHIPPING_SCREEN_PATH = "/com/example/aims_project2/fxml/shipping.fxml";
	public static final String CART_MEDIA_PATH = "/com/example/aims_project2/fxml/media_cart.fxml";
	public static final String HOME_PATH  = "/com/example/aims_project2/fxml/home.fxml";
	public static final String HOME_MEDIA_PATH = "/com/example/aims_project2/fxml/media_home.fxml";
	public static final String POPUP_PATH = "/com/example/aims_project2/fxml/popup.fxml";
